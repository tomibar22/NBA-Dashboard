...
try:
    ...
    with st.container(border=True):
            ...
            cl12.markdown(f"<p style='text-align: center;'>FT_PCT<br><b {font_size}>{(player_games[player_games['FTA'] != 0]['FT_PCT_CLEAN'].mean()*100).round(1)}%</b></p>", unsafe_allow_html=True)
